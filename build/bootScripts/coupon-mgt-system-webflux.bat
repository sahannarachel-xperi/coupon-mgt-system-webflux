...
set JARPATH=%APP_HOME%\lib\coupon-management-system.jar

@rem Execute coupon-mgt-system-webflux
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %COUPON_MGT_SYSTEM_WEBFLUX_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%COUPON_MGT_SYSTEM_WEBFLUX_EXIT_CONSOLE%" exit 1
exit /b 1
